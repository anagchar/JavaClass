...
public interface Map {
	 ...
	 * @pre | key != null
	 * @inspects | this
	 * @post | result == entrySet().stream().filter(e ->
	 *       | 			((Entry)e).getKey().equals(key)).findFirst().orElse(null)
     */
	 ...
	 * @post | old(entrySet()).stream().allMatch(e -> ((Entry)e).getKey().equals(key) || entrySet().contains(e)) // lower bound
	 * @post | entrySet().stream().allMatch(e -> ((Entry)e).getKey().equals(key) && ((Entry)e).getValue().equals(value)
	 * 		 |	||	old(entrySet()).contains(e)) // upper bound     
	 * 
	 */
	 ...
	 * @mutates | this
	 * @post | old(entrySet()).stream().allMatch(e -> ((Entry)e).getKey().equals(key) || entrySet().contains(e)) // lower bound
	 * @post | entrySet().stream().allMatch(e -> !((Entry)e).getKey().equals(key) || old(entrySet()).contains(e)) // upper bound
	 */
